...
Simple ATM API with very simple authentication. There are 4 operations supported:
...
* you may be asking yourself why all the input data is sent via URL query params: for simplicity of interacting with the API and for the ease of testing it. in a real world, probably when you make a "deposit" request, you would send the amout and other data via reequest body, and all the requests would be don thought HTTPS
